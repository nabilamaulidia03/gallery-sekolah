...
<div class="login-card">
    <div class="text-center mb-4">
        ...
        <p class="text-muted small">Masuk untuk mengakses dashboard Admin</p>
    </div>
    ...
    <form method="POST" action="">
        ...
        <div class="text-center mt-3 small">
            Belum punya akun? <a href="{{ route('admin.register') }}" class="text-primary text-decoration-none">Daftar di sini</a>
        </div>
    </form>
</div>
@endsection