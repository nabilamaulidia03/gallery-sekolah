...
<div class="container my-5 d-flex justify-content-center">
    <div class="register-card">
        <div class="text-center mb-4">
            ...
            <p class="text-muted small">Buat akun untuk mengakses dashboard Admin</p>
        </div>
        ...
        <form method="POST" action="">
            ...
            <div class="text-center mt-3 small">
                Sudah punya akun? <a href="{{ route('admin.login') }}" class="text-primary text-decoration-none">Masuk di sini</a>
            </div>
        </form>
    </div>
</div>
